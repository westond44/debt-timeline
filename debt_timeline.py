...
for i, (event, date) in enumerate(zip(events, dates)):
    ...
    if i % 2 == 0:
        plt.text(date, y_position + 0.4, event, va='bottom', ha='center', fontsize=10, rotation=15)
    else:
        plt.text(date, y_position - 0.4, event, va='top', ha='center', fontsize=10, rotation=15)
